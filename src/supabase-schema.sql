...
CREATE TABLE IF NOT EXISTS posts (
    ...
    youtube_links JSONB DEFAULT '[]'::jsonb, -- DEPRECATED - kept for backward compatibility
    external_link TEXT, -- New: Optional external link
    timetable_link TEXT, -- New: Optional timetable download link
    exam_dates JSONB DEFAULT '[]'::jsonb, -- New: Array of {subject, date} objects
