...
import { postsApi, Post, resultsApi, Result, notesApi, Note, youtubeApi, YouTubeVideo, questionsApi, Question } from '../utils/api';
            ...
            {latestPosts.length > 0 ? (
              latestPosts.map((post) => (
                <button
                  ...
                  className="block w-full bg-white rounded-lg p-6 hover:shadow-lg transition-shadow border border-gray-200 text-left"
                >
