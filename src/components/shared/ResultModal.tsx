import { X, Clock, Calendar, ExternalLink, Download } from 'lucide-react';
        ...
        <ScrollArea className="flex-1 overflow-y-auto">
          <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
            ...
            <div className="bg-[#F5F5F5] rounded-lg p-4 sm:p-6 space-y-3">
              <h3 className="text-base sm:text-lg text-[#0A0A0A]">Exam Details</h3>
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="flex flex-col gap-1">
                  <span className="text-xs text-[#0A0A0A]/60">Exam Type</span>
                  <span className="text-sm sm:text-base text-[#0A0A0A]">{result.exam_type}</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-xs text-[#0A0A0A]/60">Semester</span>
                  <span className="text-sm sm:text-base text-[#0A0A0A]">{result.semester}</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-xs text-[#0A0A0A]/60">Year</span>
                  <span className="text-sm sm:text-base text-[#0A0A0A]">{result.year}</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-xs text-[#0A0A0A]/60">Views</span>
                  <span className="text-sm sm:text-base text-[#0A0A0A]">{result.views.toLocaleString()}</span>
                </div>
              </div>
            </div>
            ...
            {/* Published Date */}
            <div className="flex items-center gap-2 text-sm text-[#0A0A0A]/60 pt-2 border-t border-gray-200">
              <Clock className="w-4 h-4" />
              <span>Published on {formatDate(result.date)}</span>
            </div>
          </div>
        </ScrollArea>
